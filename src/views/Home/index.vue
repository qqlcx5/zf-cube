<template>
  <div class="home">
    <HomeHeader :categories="categories" @listenIndex="handleCurrentIndex"></HomeHeader>
    <!-- 轮播图 -->
    <div class="slideDiv">
    ...
    <!-- 可回收的滚动列表 -->
    <div class="wrapper">
      <cube-recycle-list ref="recycleList" class="list" :size="recycleSize"
        :on-fetch="onFetch" :offset="offset">
...
export default {
  ...
  methods: {
    ...
    async onFetch() {
      if (this.hasMore) {
        const { result, hasMore } = await fetchLessonList(this.recycleSize, this.offsetIndex);
